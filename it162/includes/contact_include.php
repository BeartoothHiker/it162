...
//place your site keys here (keys for codes_with_jeremy posted here)
$siteKey = "6LdnefQeAAAAAFPyF_bWOvU3OJjilhEzrW5xLwqw";
$secretKey = "6LdnefQeAAAAAOOb-YDXgJzlSN1QKx-AVWB2LvBb";
date_default_timezone_set('America/Los_Angeles'); #sets default date/timezone for this website
$server = 'codeswithjeremy.dev';
//end config area ----------------------------------------
